import { Button, Container, Form, Grid, Header, Icon, Segment, Statistic, StatisticLabel } from 'semantic-ui-react';
import './App.css';
  ...
  return (
    <Container>
      ...
      <Statistic size='small'>
        ...
        <Statistic.Value> 2,553.85 </Statistic.Value>
      </Statistic>
          ...
          <Grid.Row>
            <Grid.Column>
              <Statistic size='tiny' color='green'>
                ...
                <Statistic.Value style={{ textAlign: "left" }}> 1,045.50</Statistic.Value>
              </Statistic>
            </Grid.Column>
            <Grid.Column>
              <Statistic size='tiny' color='red'>
                <Statistic.Label style={{ textAlign: "left" }}> Expenses :</Statistic.Label>
                <Statistic.Value style={{ textAlign: "left" }}> 763.50</Statistic.Value>
              </Statistic>
            </Grid.Column>
          </Grid.Row>
        </Grid>
      ...
      <Form unstackable>
        <Form.Group>
          <Form.Input  icon="tags" width={12} label="Description" placeholder='New Item here'></Form.Input>
